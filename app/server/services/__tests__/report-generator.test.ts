/**
 * ══════════════════════════════════════════════════════════════════════════════
 *  REPORT GENERATOR — Regression Test Suite
 *  SOP Part 7 — 120+ tests
 * ══════════════════════════════════════════════════════════════════════════════
 */
...
describe('BOQ Report Generator', () => {
  ...
  // Line items
  it('generates correct number of report lines', () => {
    // Should have lines for every non-empty estimate line
    expect(report.lines.length).toBeGreaterThan(0);
    expect(report.lines.length).toBeLessThanOrEqual(SAMPLE_ESTIMATE_LINES.length);
  });

  it('assigns CSI divisions to every line', () => {
  ...
  it('assigns trade packages to every line', () => {
    for (const line of report.lines) {
      expect(line.tradePackage).toBeTruthy();
    }
  });

  it('assigns storey to every line', () => {
    for (const line of report.lines) {
      expect(line.storey).toBeTruthy();
    }
  });

  it('splits costs into material/labour/equipment per line', () => {
    for (const line of report.lines) {
  ...
  it('applies regional factor to costs', () => {
  ...
  // Storey subtotals
  it('generates storey subtotals', () => {
    expect(report.storeySubtotals.length).toBeGreaterThan(0);
  });

  it('has Level 1 and Level 2 subtotals', () => {
  ...
  it('storey subtotals sum to direct cost', () => {
  ...
  // Division subtotals
  it('generates division subtotals', () => {
    expect(report.divisionSubtotals.length).toBeGreaterThan(0);
  });

  it('includes Division 03 (Concrete)', () => {
  ...
  it('division subtotals sum to direct cost', () => {
  ...
  it('generates trade package subtotals', () => {
    expect(report.tradePackageSubtotals.length).toBeGreaterThan(0);
  });

  it('trade package subtotals sum to direct cost', () => {
  ...
  it('calculates contingency on subtotal (direct + OH + P)', () => {
  ...
  it('calculates tax on subtotal after contingency', () => {
  ...
  it('total project cost includes all components', () => {
  ...
  it('total project cost is positive', () => {
    expect(report.totalProjectCost).toBeGreaterThan(0);
  });

  // Confidence
  it('calculates confidence summary', () => {
  ...
  it('detects GAP items (no evidence)', () => {
...
describe('Bid-Leveling Sheet Generator', () => {
  ...
  it('generates Concrete alternates when Concrete trade exists', () => {
...
describe('Clash Report Generator', () => {
  ...
  it('counts total clashes correctly', () => {
  ...
  it('includes missing clearance data', () => {
    expect(report.missingClearanceData.length).toBeGreaterThan(0);
  });

  it('handles empty clash result', () => {
...
describe('Constructability Report Generator', () => {
  ...
  it('lists trade dependencies', () => {
    expect(report.tradeDependencies.length).toBe(3);
  });

  it('identifies hold points', () => {
    expect(report.holdPoints.length).toBe(2);
  });

  it('lists safety issues sorted by severity', () => {
  ...
  it('builds trade execution order', () => {
...
describe('Executive Summary Generator', () => {
  ...
  it('includes cost summary with all components', () => {
  ...
  it('includes accuracy range for Class3', () => {
  ...
  it('generates recommendations based on findings', () => {
    expect(summary.recommendations.length).toBeGreaterThan(0);
  });

  it('includes key assumptions', () => {
    expect(summary.keyAssumptions.length).toBeGreaterThan(0);
  });

  it('includes exclusions', () => {
    expect(summary.exclusions.length).toBeGreaterThan(0);
  });

  it('handles null optional modules', () => {
...
describe('Gap Register Generator', () => {
  ...
  it('counts RFIs generated', () => {
    expect(register.rfisGenerated).toBe(2);
  });

  it('breaks down by discipline', () => {
...
describe('Schedule of Values Generator', () => {
  ...
  it('generates phases without sequencing model', () => {
  ...
  it('includes mobilization phase', () => {
  ...
  it('each phase has trade breakdown', () => {
    const sov = generateScheduleOfValues(PROJECT_ID, PROJECT_NAME, boq, null);
    for (const phase of sov.phases) {
  ...
  it('uses sequencing model when provided', () => {
    const mockSeq = {
      phases: [
...
describe('Text Formatters', () => {
  ...
  it('Executive Summary text includes cost breakdown', () => {
...
describe('Edge Cases', () => {
  it('handles empty estimate lines', () => {
  ...
  it('bid-leveling works with zero-cost trades', () => {
  ...
  it('clash report handles null/undefined fields', () => {
  ...
  it('executive summary without optional modules', () => {
